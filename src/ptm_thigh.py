# -*- coding: utf-8 -*-
"""
Created on Thu Mar 18 21:38:57 2021
thigh model
train a model for thigh, use trial1+trial2 data
...
plt.savefig('thigh_model.png')

# serialize model to JSON
model_json = model.to_json()
with open("4act_thigh.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("4act_thigh.h5")
