...
PTM: ankle+thigh sensor
stack both ankle and thigh as input
...
with tf.device('/gpu:0'): 
    ...
    plt.savefig('ankle_thigh_model.png')
    
    # serialize model to JSON
    model_json = model.to_json()
    with open("ankle_thigh.json", "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    model.save_weights("ankle_thigh.h5")
